...
class Simon:
    ...
    def iniciarBotones(self):
        ...
        self.botonRojo.place(x=155,y=100) 
    ...
    def crearColor(self):
        if self.juegoI:
            color_map = {
                "Azul": (self.botonAzul, "#ADD8E6", "#0000FF", 500, 500), 
            "Amarillo": (self.botonAmarillo, "#FFA500", "#FFFF00", 600, 500),
            "Rojo": (self.botonRojo, "#FFA500", "#FF0000", 700, 500),
            "Verde": (self.botonVerde, "#00FF00", "#008000", 800, 500)
            }
